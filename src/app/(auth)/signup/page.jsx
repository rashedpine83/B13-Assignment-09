        ...
        <div className="w-full max-w-md">
          <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-2xl space-y-8 relative overflow-hidden">
            ...
            <div className="text-center space-y-2 relative">
              <h2 className="text-3xl font-bold text-[#0c2461] tracking-tight">
                Join{" "}
            ...
            <div className="space-y-4">
              <Button
                ...
                variant="bordered"
                className="w-full h-12 font-bold rounded-2xl border-slate-200 hover:bg-slate-200 transition-colors gap-3"
              >
                <FcGoogle />
                Sign in with Google
              </Button>
            ...
            <form className="space-y-4" onSubmit={onSubmit}>
              <div className="space-y-3">
                ...
                <Input
                  ...
                  name="name"
                  startadornment={<User className="w-5 h-5 text-slate-400" />}
